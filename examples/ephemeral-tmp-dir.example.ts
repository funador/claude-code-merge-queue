...
const REGISTRY_DIR = join(tmpdir(), "claude-code-merge-queue-example-ephemeral-registry");
const RESOURCE_ROOT = join(tmpdir(), "claude-code-merge-queue-example-ephemeral-resources");
