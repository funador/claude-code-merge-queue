...
export function laneNumberFromPath(path: string, cfg: Pick<LaneKeeperConfig, "worktreeSuffix">): number | null {
...
export function lanePort(path: string, cfg: Pick<LaneKeeperConfig, "worktreeSuffix" | "portBase">): number | null {
